...
const ProductItem = ({ id, image, name, price, date, location }) => {
  ...
  return (
    <div className="rtl w-full h-[260px] bg-white dark:bg-myColor rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow text-right">
        <div className="flex justify-between items-right">
          <h3 className="text-lg font-primary dark:text-colorwhite font-bold text-gray-800">
  ...
  {price
    ...
    .replace(/[0-9]/g, d => '۰۱۲۳۴۵۶۷۸۹'[d]) // تبدیل به عدد فارسی
        ...
        <div className="flex rtl items-center justify-between dark:text-colorwhite1 mt-4">
